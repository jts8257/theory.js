...
<p> console.dir(foo) <br>
  MDN(https://developer.mozilla.org/en-US/docs/Web/API/Console/dir)에 따르면 console의 dir 메서드는 JS의 특정 객체의 프로퍼티의 리스트를 보여준다. 이때 상속되는 관계를 명확히 파악할 수 있도록 보여주며, 이를 통해 foo의 상위 객체에 toString이 있음을 알 수 있다. </p>
